        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Add New Program Unit</div>
                    ...
                    <div class="panel-body">
                        ...
                        <form @submit.prevent="save" action="/sosmed/business-unit" method="post">
                            <div :class="['form-group', errors.name ? 'has-error': '']">
                                ...
                                <select class="form-control" name="unit" v-model="state.group">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group" v-for="(s,index) in sosmed">
                                    ...
                                    <input class="form-control" :placeholder="s.sosmed_name">
                                </div>
                            </fieldset>
