                ...
                <div class="card-body">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#highlight-tab4" role="tab" aria-controls="nav-contact" aria-selected="false">YOUTUBE BROKEN LINK</a>
                        </div>
                    </nav>
                    <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="highlight-tab4" role="tabpanel" aria-labelledby="nav-home-tab">
