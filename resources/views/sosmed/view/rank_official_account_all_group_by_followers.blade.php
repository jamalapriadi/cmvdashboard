...
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title text-center">
            2. RANK OF OFFICIAL ACCOUNT ALL TV <span style="color:red">BY TOTAL FOLLOWERS</span>
        </h6>
    </div>
    <div class="panel-body">
        <?php
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title text-center">
            3.RANK OF OFFICIAL ACCOUNT ALL GROUP <span style="color:red">BY % GROWTH YESTERDAY</span>
        </h6>
    </div>
    <div class="panel-body">
        <?php 
        ...
        <table class='table table-striped'>
            <thead>
                ...
                <tr>
                    ...
                    <th class='text-center' style='background:#5054ab;color:white'>% Growth</th>
                    <th class='text-center' style='background:#5054ab;color:white'>RANK</th>
                    <th class='text-center' style='background:#a958a5;color:white'>Num Of Growth</th>
                    <th class='text-center' style='background:#a958a5;color:white'>% Growth</th>
                    <th class='text-center' style='background:#a958a5;color:white'>RANK</th>
                </tr>
            </thead>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title text-center">
            4.RANK OF OFFICIAL ACCOUNT ALL TV <span style="color:red">BY % GROWTH YESTERDAY</span>
        </h6>
    </div>
    <div class="panel-body">
        <?php
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title text-center">
            5.RANK OF OVERALL ACCOUNT FOR ALL GROUP <span style="color:red">BY TOTAL FOLLOWERS</span>
        </div>
    </div>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title text-center">
            6.RANK OF OVERALL ACCOUNT FOR ALL TV <span style="color:red">BY TOTAL FOLLOWERS</span>
        </h6>
    </div>
    <div class="panel-body">
        <?php 
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title text-center">
            7.RANK OF OVERALL ACCOUNT FOR ALL GROUP <span style="color:red">BY % GROWTH FROM YESTERDAY</span>
        </h6>
    </div>
    <div class="panel-body">
        <?php 
        ...
        <table class='table table-striped'>
            <thead>
                ...
                <tr>
                    ...
                    <th class='text-center' style='background:#5054ab;color:white'>% Growth</th>
                    <th class='text-center' style='background:#5054ab;color:white'>RANK</th>
                    <th class='text-center' style='background:#a958a5;color:white'>Nom Of Growth</th>
                    <th class='text-center' style='background:#a958a5;color:white'>% Growth</th>
                    <th class='text-center' style='background:#a958a5;color:white'>RANK</th>
                </tr>
            </thead>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title text-center">
            8.RANK OF OVERALL ACCOUNT FOR ALL TV <span style="color:red">BY % GROWTH FROM YESTERDAY</span>
        </h6>
    </div>
    <div class="panel-body">
        <?php 
